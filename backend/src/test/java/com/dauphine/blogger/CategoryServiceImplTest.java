...
public class CategoryServiceImplTest {
    ...
    public void getAllCategoriesByName() {
        ...
        when(categoryRepository.findByName(name)).thenReturn(List.of(category));
    ...
    public void getCategoryByIdWhenIdDoesNotExist() {
        ...
        Exception exception = assertThrows(CategoryNotFoundexception.class, () -> categoryService.getById(id));
